...
-   Mithilfe von Fehlermatrizen die Genauigkeit eine thematischen Karte beruteilen
-   den Untscheid zwischen der Modell- und der Kartengenauigkeit erläutern können.
...
wollen wir ein systematisches Raster mit einer Rasterweite von 2000 m x 2000 m anlegen. QGIS bietet
eine entsprechende Funktion unter `Vektor->Forschungswerkzeuge-> Gitter erzeugen`. Hier wählen wir:

-   Gittertyp = Punkt
-   Gitterausdehnung = Aus Layer berechnen Gemeindegrenzen Stadt Göttingen
-   Horizontaler Abstand = 2000 m
-   Vertikaler Abstand = 2000 m
-   Gitter-KBS = 25832

Da das Raster nur auf die Ausdehnung des Polygons zugeschnitten wird, umfasst es noch Punkte
außerhalb der Gemeindegrenzen. Um diese zu entfernen nutzen wir die Funktion

`Menü-> Vektor-> Geoverarbeitungswerkzeuge-> Zuschneiden` mit folgenden Einstellungen:

-   Eingabelayer = Gitter
-   Layer überlagern = Gemeinde Grenzen der Stadt Göttingen
-   Zugeschnitten = Wir speichern die Punkte als neues Layer (‚Validierungspunkte‘) im geopackage
    „uebung08.gpkg“
...
wir jedem Punkt die Landbedeckungsklasse(Code) des Klassifikationsschemas zu.
