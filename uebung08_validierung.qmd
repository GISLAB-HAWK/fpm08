...
bei der Bildklassifikation zu wählen. Eine entsprechend vorbereiteten Stil für das Punktraster
können sie unter folgendem Link herunterladen:

<https://cloud.hawk.de/index.php/s/tBqHkG9NxbaoiW5>

Zum laden des neuen Stils gehen öffnen sie:
`Layereigenschaften -> Symbolisierung -> Stil ->Stil laden -> aus Datei` Dort wählen sie dann die
\*.qml Datei aus.

![](images/LE08_stil_punktraster.png)
