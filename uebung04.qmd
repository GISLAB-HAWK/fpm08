...
2.  Untersuchen sie die Ordnerstruktur des Satellitebproduktes und importieren sie die Bänder B02,
    B03, B04 und B08 mit einer räumlichen Auflösung von 10 m.
3.  Erstellen Sie ein CIR-Bild des westlichen Teils des NP-Harzes
4.  
...
Der Browser bietet umfrangreiche Möglichkeient nach Geodatenprodukten zu suchen.
...
Format zum speichern von Vektordaten. Für die Übung soll die Außengrenze des NP-Harz genutzt werden.
Das entsprechende GeoJSON kann hier heruntergeladen werden:
...
![Upload der Gebietsgrenzen als GeoJSON](images/LE04_dataspace_area_definition.png)
...
Im Abschnitt "Time Range" kann festgelegt werden in welchem Zeitraum wird Bilder suchen. Für die
Übung möchten wir eine Aufnahme aus dem Juni 2025 suchen:
...
Die Ergebnisliste zeigt mehrere Aufnahmen, welche unseren Kriterien entsprechen. Keine der Aufnahmen
deckt den gesamten Bereich des Nationalparks ab. Für die Übung wählen wir die zwei Kacheln vom
12.6.2025 welche den Nationalpark abdecken:
...
Laden sie anschließend die gesamte Szene als Datei herunter und speicher sie die ZIP-Datei in ihrem
Projektordner unter "daten".
...
ausgegeben. Nach dem Entpacken der ZIP-Datei finden sie folgende Ordnerstruktur:
...
Fügen sie die Bänder B02, B03,B04 und B08 mit einer räumlichen Auflösung zu ihrem QGIS-Projekt
hinzu.
...
Erstellen sie für beide KAcheln ein virtuelles Mehrkanalraster, speichern sie das virtuelle Raster
unter S2B_MSIL2A_20250612T102559_N0511_R108_T32UNC_20250612T131505.vrt und
S2B_MSIL2A_20250612T102559_N0511_R108_T32UPC_20250612T131505.vrt ab. Erstellen sie anschließend ein
vituellles Satellitenbildmosaik und stellen sie es in QGIS als CIR-Bild dar. Folgen sie dazu auch
der Anleitung aus der LE02 @sec-mehrkanalbilder.

::: {style="border: 3px solid #ff8a0b; background-color: #ffffff; padding: 8px;"}
**Vergleichen sie die CIR-Darstellung innerhalb und außerhalb des Nationalparks:**

1.) Welche Unterschiede in den Farben können sie feststellen?

2.) Wie interpretieren Sie diese Unterschiede?
:::
...
Speichern sie das neue Raster unter dem Namen NP_Harz_2025_06_12 als GeoTIFF im Unterordner "daten"
ab und laden sie die Satellitenbildkarte als CIR-Falschfarbenbild in QGIS. Überlagern sie das Bild
mit den originalen Außengrenzen des Nationalparks.
