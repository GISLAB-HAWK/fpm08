...
# Lerneinheit 08: Analyse der Genauigkeit einer thematischen Waldtypenkarte
![](images/LE07_cover_image.png){fig-align="center"}

## Lernziele & Aufgabenstellung

In der der Übung LE06 (@sec-Bildklassifikation) wurde mithilfe eines automatischen Klassifikationsverfahrens eine einfache Waldtypenkarte für den Nationalpark Harz erstellt. In der vorliegenden Lerneinheit soll diese Karte validiert werden um die Kartengenauigkeit zu ermitteln.
...
-   Validierungsdaten anlegen
-   Ein Fehlermatrix erstellen
-   Mithilfe der Fehlermatrix die Gesamt-, Nutzer- und Produzentengenauigkeit bestimmen. 
...
QGIS-Projekt für LE08 anzulegen. In der Übung bietet es sich an den Ordner *"daten"* weiter in die
...
## Aufgabe 03: Training eines Klassifikationsmodells
