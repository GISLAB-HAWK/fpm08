...
# Lerneinheit 09: Analyse der Waldflächenänderung im Nationalpark Harz (2017-2025)
...
welches zu einem ähnlichen phänologischen Zeitpunkt (Juni) aufgenommen wurde. Sie können das
vorbereitete Sentinel-2 Satellitenbild hier herunterladen:

<https://cloud.hawk.de/index.php/s/QWPY2984sb3jmT9>

Für die farbige Darstellung der thematischen Karte können Sie die Stildatei zusätzlich
herunterladen:

<https://cloud.hawk.de/index.php/s/HKMseitrK9bHpZY>
...
@sec-le07 auf Basis der Trainingsdaten angelegt haben noch einmal.
...
erstellen. Speichern sie die neue Waldtypenkarte als Raster unter dem Dateinamen
*NP_Harz_2017_06_01_Waldtypen.tif* ab. Nutzen sie dazu auch die Hinweise aus @sec-rf_inference.

Stellen sie vor dem nächsten Schritt sicher, dass die Waldtypenkarte des Jahres 2017 auf den NP-Harz
zugeschnitten sind.

::: callout-tip
## Tipp

In der OTB-Funktion *imageClassifier* können sie eine Maske angeben. Wenn sie hier das
Satellitenbild *NP_Harz_2017_06_12.tif* wählen, wir die Klassifikation direkt auf den Bereich des
NP-Harzes beschränkt und die äußeren Flächen als Leerwerte markiert.
:::
...
Als Ergebnis wird eine Textdatei erzeugt, in der die Pixelwerte aus dem Jahr 2017 in den Spalten und
die Referenzwerte aus dem Jahr 2025 in den Zeilen aufgetragen sind. In der Diagonale befinden sich
die Pixel die zu beiden Zeitpunkten der gleichen Klasse zugeordnet wurden.
...
Zeitpunkte zu erstellen. Dabei sollten zwei Versionen der Änderungsmatrix erarbeitet werden:

i)  mit der Anzahl der Pixel
ii) mit den ha-Werten.
